...
public:	
	...
	UPROPERTY(BlueprintReadOnly, VisibleAnywhere, Category = "GSC|Projectile")
	UProjectileMovementComponent* ProjectileMovement;

	/** Whether to draw debug traces on explosion sphere */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Meta = (ExposeOnSpawn = true), Category = "GSC|Projectile")
	...
	UPROPERTY(BlueprintReadWrite, Meta = (ExposeOnSpawn = true), Category = "GSC|Projectile")
