...
#include "ACFAbilityTask_PlayMontageAndWaitForEvent.generated.h"

class UAnimMontage;
class UACFAbilitySystemComponent;

DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FACFPlayMontageAndWaitForEventDelegate, FGameplayTag, EventTag, FGameplayEventData, EventData);
...
*/
UCLASS()
class ADVANCEDCOMBATSYSTEM_API UACFAbilityTask_PlayMontageAndWaitForEvent : public UAbilityTask
{
	GENERATED_BODY()
	
public:
	UACFAbilityTask_PlayMontageAndWaitForEvent(const FObjectInitializer& ObjectInitializer);
	...
	FACFPlayMontageAndWaitForEventDelegate OnCompleted;

	/** The montage started blending out */
	UPROPERTY(BlueprintAssignable)
	FACFPlayMontageAndWaitForEventDelegate OnBlendOut;

	/** The montage was interrupted */
	UPROPERTY(BlueprintAssignable)
	FACFPlayMontageAndWaitForEventDelegate OnInterrupted;

	/** The ability task was explicitly cancelled by another ability */
	UPROPERTY(BlueprintAssignable)
	FACFPlayMontageAndWaitForEventDelegate OnCancelled;

	/** One of the triggering gameplay events happened */
	UPROPERTY(BlueprintAssignable)
	FACFPlayMontageAndWaitForEventDelegate EventReceived;
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "ACF | Abiltiy| Tasks", meta = (HidePin = "OwningAbility", DefaultToSelf = "OwningAbility", BlueprintInternalUseOnly = "TRUE"))
	static UACFAbilityTask_PlayMontageAndWaitForEvent* PlayMontageAndWaitForEvent(
...
private:
	...
	UACFAbilitySystemComponent* GetTargetASC() const;
